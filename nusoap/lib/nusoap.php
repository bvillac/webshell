<?php
/*
 * CAMBIRO EN EL ARCHIVOR by Byron
 * 1.-Byron 03-12-2014 se cambio $response_timeout 30seg a 600seg =>10 min
 *      Aumenta el Tiempo en la respuesta para que no se pare el servicio...
 * 2.-Byron 15-12-2014 Se cambio a UF8 en la LInea 147 por codificacion...
 */
...
class nusoap_base {
	...
	*/
	...
	var $soap_defencoding = 'UTF-8';//Cambio Byron Por Codificacion UTF-0 15 Dic
...
class soap_transport_http extends nusoap_base {
	...
	* @access   private
	*/
	function connect($connection_timeout=0,$response_timeout=600){ //Byron 03-12-2014 se cambio $response_timeout 30seg a 600seg =>10 min
	  	// For PHP 4.3 with OpenSSL, change https scheme to ssl, then treat like
	  	// "regular" socket.
	  	// TODO: disabled for now because OpenSSL must be *compiled* in (not just
	  	//       loaded), and until PHP5 stream_get_wrappers is not available.
                /****DESCOMENATADO POR BYRON****/
...
//		}
		...
		if ($this->scheme == 'https') {
			...
			$this->setCurlOption(CURLOPT_SSL_VERIFYHOST, 0);
                        /*********Below is what needed to be added********/
                        //$this->setCurlOption(CURLOPT_SSLVERSION, 3);//Byron correccion SSL 15-12-2015
	...
	* @access   public
	*/
	function send($data, $timeout=0, $response_timeout=600, $cookies=NULL) {//Byron 03-12-2014 se cambio $response_timeout 30seg a 600seg =>10 min
	...
	* @deprecated
	*/
	function sendHTTPS($data, $timeout=0, $response_timeout=600, $cookies) {//Byron 03-12-2014 se cambio $response_timeout 30seg a 600seg =>10 min
...
class wsdl extends nusoap_base {
	...
	var $proxypassword = '';
	var $timeout = 0;
	var $response_timeout = 600;//Byron 03-12-2014 se cambio $response_timeout 30seg a 600seg =>10 min
     ...
     * @access public 
     */
    //Byron 03-12-2014 se cambio $response_timeout 30seg a 600seg =>10 min
    			...
    			foreach ($list as $xs) {
		            ...
		            foreach ($xs->imports as $ns2 => $list2) {
		                for ($ii = 0; $ii < count($list2); $ii++) {
		                	if (! $list2[$ii]['loaded']) {
		                		//$this->schemas[$ns]->imports[$ns2][$ii]['loaded'] = true; Modificado Byron 24 Nov 2014
...
class nusoap_client extends nusoap_base  {
	...
	var $response_timeout = 600;		// HTTP response timeout  Byron 03-12-2014 se cambio 30seg a 600seg =>10 min
	...
	* @access   private
	*/
	function send($msg, $soapaction = '', $timeout=0, $response_timeout=600) {//Byron 03-12-2014 se cambio $response_timeout 30seg a 600seg =>10 min
		$this->checkCookies();
		// detect transport
		switch(true){
			// http(s)
